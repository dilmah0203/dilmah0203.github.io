...
Java 8 HashMap 보조 해시 함수는 상위 16비트 값을 XOR 연산하는 매우 단순한 형태의 보조 해시 함수를 사용한다. 상위 16비트와 하위 16비트를 XOR 연산하여 새로운 해시 값을 생성하는데 해시 값의 분포를 더욱 균등하게 만들어 해시 테이블의 성능을 향상시킨다.
