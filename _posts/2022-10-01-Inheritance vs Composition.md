...
![img](https://github.com/dilmah0203/TIL/blob/main/Image/Stack.png?raw=true)
...
![img3](https://github.com/dilmah0203/TIL/blob/main/Image/StackTest2.png?raw=true)
...
이 두가지의 서로 다른 **상속**의 차이는 상위 클래스의 행동과 하위 클래스의 행동의 호환여부이다. 두 객체가 서로 **Is-A** 관계이거나 클라이언트 관점에서 두 객체가 동일한 행동을 할 것이라 기대될 때 상속을 고려한다.
